    ...
    public partial class AddDiscriminatorColumn : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorCat", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Message_AspNetUsers_ApplicationUserId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SystemUsageLog", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SystemUsageLog_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    PlannerUserId = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_weddingPlanner", x => x.Id);
                    table.ForeignKey(
                        name: "FK_weddingPlanner_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoupleMember", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoupleMember_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CoupleMember_Couple_CoupleId",
                        column: x => x.CoupleId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RSVPStatus = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    Allergies = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SeatingArrangement = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsDeleted = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeddingBudget", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WeddingBudget_Couple_CoupleId",
                        column: x => x.CoupleId,
                        principalTable: "Couple",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeddingChecklist", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WeddingChecklist_Couple_CoupleId",
                        column: x => x.CoupleId,
                        principalTable: "Couple",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeddingTimeline", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WeddingTimeline_Couple_CoupleId",
                        column: x => x.CoupleId,
                        principalTable: "Couple",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Vendor_VendorCat_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "VendorCat",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                name: "CoupleWeddingPlanner",
                columns: table => new
                {
                    AssignedCouplesId = table.Column<int>(type: "int", nullable: false),
                    PlannersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoupleWeddingPlanner", x => new { x.AssignedCouplesId, x.PlannersId });
                    table.ForeignKey(
                        name: "FK_CoupleWeddingPlanner_Couple_AssignedCouplesId",
                        column: x => x.AssignedCouplesId,
                        principalTable: "Couple",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CoupleWeddingPlanner_weddingPlanner_PlannersId",
                        column: x => x.PlannersId,
                        principalTable: "weddingPlanner",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUserId = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CoupleMemberId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuditLog", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AuditLog_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AuditLog_CoupleMember_CoupleMemberId",
                        column: x => x.CoupleMemberId,
                        principalTable: "CoupleMember",
                        principalColumn: "Id");
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VendorAvailability_Vendor_VendorId",
                        column: x => x.VendorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorPackage", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VendorPackage_Vendor_VendorId",
                        column: x => x.VendorId,
                        principalTable: "Vendor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorRating", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VendorRating_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VendorRating_Vendor_VendorId",
                        column: x => x.VendorId,
                        principalTable: "Vendor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorService", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VendorService_Vendor_VendorId",
                        column: x => x.VendorId,
                        principalTable: "Vendor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IndoorOutdoor = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Booking_Couple_CoupleId",
                        column: x => x.CoupleId,
                        principalTable: "Couple",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Booking_VendorService_VendorServiceId",
                        column: x => x.VendorServiceId,
                        principalTable: "VendorService",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Booking_Vendor_VendorId",
                        column: x => x.VendorId,
                        principalTable: "Vendor",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLog_ApplicationUserId",
                table: "AuditLog",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AuditLog_CoupleMemberId",
                table: "AuditLog",
                column: "CoupleMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_Booking_CoupleId",
                table: "Booking",
                column: "CoupleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Booking_VendorServiceId",
                table: "Booking",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoupleMember_ApplicationUserId",
                table: "CoupleMember",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CoupleMember_CoupleId",
                table: "CoupleMember",
                column: "CoupleId");

            migrationBuilder.CreateIndex(
                name: "IX_CoupleWeddingPlanner_PlannersId",
                table: "CoupleWeddingPlanner",
                column: "PlannersId");

            migrationBuilder.CreateIndex(
                name: "IX_Guest_CoupleId",
                table: "Guest",
                column: "CoupleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Message_ApplicationUserId1",
                table: "Message",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemUsageLog_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendorAvailability_VendorId",
                table: "VendorAvailability",
                column: "VendorId");

            migrationBuilder.CreateIndex(
                name: "IX_VendorPackage_VendorId",
                table: "VendorPackage",
                column: "VendorId");

            migrationBuilder.CreateIndex(
                name: "IX_VendorRating_UserId",
                table: "VendorRating",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_VendorRating_VendorId",
                table: "VendorRating",
                column: "VendorId");

            migrationBuilder.CreateIndex(
                name: "IX_VendorService_VendorId",
                table: "VendorService",
                column: "VendorId");

            migrationBuilder.CreateIndex(
                name: "IX_Venue_VendorId",
                table: "Venue",
                column: "VendorId");

            migrationBuilder.CreateIndex(
                name: "IX_WeddingBudget_CoupleId",
                table: "WeddingBudget",
                column: "CoupleId");

            migrationBuilder.CreateIndex(
                name: "IX_WeddingChecklist_CoupleId",
                table: "WeddingChecklist",
                column: "CoupleId");

            migrationBuilder.CreateIndex(
                name: "IX_weddingPlanner_ApplicationUserId",
                table: "weddingPlanner",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_WeddingTimeline_CoupleId",
